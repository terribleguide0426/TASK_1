...
namespace GADE_POE
{
    public class Map
    {
        ...
        public void CreatingMap(Form active)
        {
            ...
            for (int i = 0; i < 20; i++)// used to make base map of dirt
            {
                for (int m = 0; m < 20; m++)
                {
            ...
            for (int i = 0; i < 20; i++)
            {
                ...
                public void Picture_Click(object sender, EventArgs args)
                {
                    ...
                    for (int x = 0; x < 20; x++)// locate pic in array
                    {
                        for (int y = 0; y < 20; y++)
                        {
                            if (((PictureBox)sender) == pictureBoxArray[x, y])   //this displays the stats
                    {
                                picX = x;
                                picY = y;
